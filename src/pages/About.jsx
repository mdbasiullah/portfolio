          ...
          <div className=' grid md:grid-cols-2 sm:gap-x-25 items-center mt-4'>
            <div className=' flex items-center gap-1 mt-4'>
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">Md Basiullah</p>
              </div>
            </div>
            <div className=' flex items-center gap-1 mt-4'>
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">19 Years</p>
              </div>
            </div>
            <div className=' flex items-center gap-1 mt-4'>
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">Darbhanga, Bihar</p>
              </div>
            </div>
            <div className=' flex items-center gap-1 mt-4'>
            ...
            <div className=' flex items-center gap-1 mt-4'>
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">mdbasiullah0@gmail.com</p>
              </div>
            </div>
            <div className=' flex items-center gap-1 mt-4'>
