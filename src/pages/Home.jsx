  ...
  return (
    <div className=' bg-black text-white min-h-screen p-4 md:flex justify-center items-center '>
      <div className=" text-center md:text-left md:w-1/2 flex flex-col justify-center">
        ...
        <h1 className='text-4xl font-bold'>MD <span className=''>BASIULLAH</span></h1>
       ...
       <div className='flex justify-center gap-4 mt-8 flex-wrap bg-black'>
          <a href="https://github.com/mdbasiullah" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white text-2xl">
            <FaGithub />
          </a>
          <a href="https://www.linkedin.com/in/mdbasiullah" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white text-2xl">
            <FaLinkedin />
          </a>
           <a href="https://www.instagram.com/_rehaansheikh?stkn=MXUxbGNwOGVtYWtkcQ==" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white text-2xl">
            <FaInstagram />
          </a>
       </div>
      </div>
